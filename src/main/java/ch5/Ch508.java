...
public class Ch508 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Field f1 = new Field("booknumber", "0000006", Field.Store.YES, Field.Index.UN_TOKENIZED);
        ...
        f3 = new Field("publishdate", "1970-01-01", Field.Store.YES, Field.Index.TOKENIZED);
        doc3.add(f1);
        doc3.add(f2);
        doc3.add(f3);
        ...
        for (int i = 0; i < hits.length(); i++) {
         ...
         //   System.out.println(searcher.explain(rq, hits.id(i)).toString());
            System.out.println("------------------------------------------");
        }
    }
}
