...
public class Ch513 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        RangeQuery rq = new RangeQuery(begin, end, true);
        //使用AdvancedSecurityFilter来作为检索结果的过滤器
        //  Hits hits = searcher.search(rq, new AdvancedSecurityFilter());
        //同上Filter使用两种实现方式
        Hits hits = searcher.search(rq, new Ch514());
        //打印索引文档信息
